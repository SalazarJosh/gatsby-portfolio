...
export const IndexPageTemplate = ({
  ...
  <div class="container">
    ...
    <div className="divider"></div>
    <div className="spacer-lg"></div>
    <h2 className="homepage-h2">Shaping My Career</h2>
    <div className="spacer-sm"></div>
    <div className="columns">
      <div className="column">
        <div className="worked-places-container">
          ...
          viewBox="0 0 108 108" xmlSpace="preserve">
            <circle class="st0" cx="54.05" cy="54.01" r="53.95"/>
            <path class="st1" d="M54.17,68.8L41.24,51.02v12.93h5.17v12.77H22.48V63.95h4.85V44.07h-4.85V31.29h18.8l12.96,17.94l12.98-17.94
      ...
      <div className="column">
        <div className="worked-places-container">
          ...
          viewBox="0 0 108 108" xmlSpace="preserve">
            <circle class="st0" cx="54.05" cy="54.01" r="53.95"/>
            <polygon class="st3" points="46.28,36.07 57.07,31.29 80.17,31.29 86.71,36.07 81.73,46.93 64.74,46.93 68.14,39.35 61.91,39.35 
            ...
            <polygon class="st3" points="25.21,71.15 77.22,71.15 75.54,74.89 23.53,74.89 	"/>
            <polygon class="st2" points="24.8,75.54 24.22,76.72 76.8,76.72 79.3,71.15 77.97,71.15 76,75.54 	"/>
            <polygon class="st2" points="80.04,53.44 81.55,53.44 76.6,64.48 65.1,69.6 40.15,69.6 34.18,65.09 34.74,63.85 40.4,68.1 
            64.72,68.1 75.45,63.36 	"/>
            <polygon class="st2" points="35.91,59.18 27.95,59.18 27.48,60.23 35.44,60.23 	"/>
            <polygon class="st2" points="27,53.02 38.68,53.02 38.14,54.22 26.41,54.22 	"/>
            <polygon class="st2" points="32.42,41.68 31.91,42.79 43.27,42.79 43.76,41.68 	"/>
            <polygon class="st2" points="53.79,59.44 55.46,59.44 63.52,41.48 67.18,41.48 67.83,40.07 62.54,40.07 	"/>
      ...
      <div className="column">
        <div className="worked-places-container">
          ...
          viewBox="0 0 108 108" xmlSpace="preserve">
            <circle class="st0" cx="54.05" cy="54.01" r="53.95"/>
            <path class="st4" d="M54.25,40.69c2.61,0,4.73-2.12,4.73-4.73c0-2.61-2.12-4.73-4.73-4.73c-2.61,0-4.73,2.12-4.73,4.73
            C49.52,38.57,51.64,40.69,54.25,40.69z"/>
            <path class="st4" d="M66.22,54.54H42.28c-0.65,0-1.18,0.53-1.18,1.18v2.24c0,0.65,0.53,1.18,1.18,1.18h23.94
            c0.65,0,1.18-0.53,1.18-1.18v-2.24C67.4,55.07,66.87,54.54,66.22,54.54z"/>
            <path class="st4" d="M61.92,61.04H46.57c-0.81,0-1.46,0.66-1.46,1.46v12.93c0,0.74,0.6,1.34,1.34,1.34h15.6
            c0.74,0,1.34-0.6,1.34-1.34V62.5C63.38,61.69,62.73,61.04,61.92,61.04z"/>
            <path class="st4" d="M63.45,46.94c0-1.8-1.16-3.39-2.86-3.95l-0.01,0l-2.5-0.41c-0.21-0.07-0.44,0.05-0.52,0.26l-2.84,7.78
            ...
            <path class="st4" d="M55.33,42.45c-0.11-0.12-0.28-0.19-0.45-0.19h-1.26c-0.17,0-0.34,0.06-0.45,0.19
